...
(test-error 'string-2 (string 5))
(test 'string-3 (string #\b #\newline #\c #\") "b\nc\"")
(test-error 'string-4 (string #\b 5 #\c #\"))
(test-error 'string-5 (string 5 #\newline #\c #\"))
...
(test 'string-ref-4 (string-ref "aha" 0) #\a)
(test 'string-ref-5 (string-ref "aa\n" 2) #\newline)
...
(test-error 'string=?-1 (string=? 5 "a"))
(test-error 'string=?-2 (string=? "a" 5))
...
(test-error 'string-ci=?-1 (string-ci=? 5 "a"))
(test-error 'string-ci=?-2 (string-ci=? "a" 5))
...
(test-error 'string-fill!-1 (string-fill! 5 #\a))
(test-error 'string-fill!-2 (string-fill! (string #\a #\b #\c) 5))
(test-error 'string-fill!-2 (string-fill! "abc" #\a)) ; immutable string
(test 'string-fill!-3
      (let ((s (string)))
	(string-fill! s #\a)
	s)
