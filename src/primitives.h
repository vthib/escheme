...
escm_atom *escm_read_only_x(escm *, escm_atom *);
escm_atom *escm_read_only_p(escm *, escm_atom *);

escm_atom *escm_prim_assert(escm *, escm_atom *);
...
escm_atom *escm_test(escm *, escm_atom *);
