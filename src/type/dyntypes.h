...
#  error "\"dyntypes\" requires the \"number\" implementation."
# endif /* ESCM_USE_NUMBERS */

# if !defined ESCM_USE_CHARACTERS
#  error "\"dyntypes\" requires the \"character\" implementation."
# endif /* ESCM_USE_CHARACTERS */

# include "types.h"

# define ESCM_ISTYPE(e, t) (ESCM_ISINT(t) && escm_number_ival(t) > 0 \
                            && (size_t) escm_number_ival(t) < e->ntypes)
